  ...
  return (
    <div className="product-card">
      <div className="product-card__img-wrap">
        {product.badge && (
          <span
            className={`product-card__badge product-card__badge--${product.badgeType}`}
          >
            {product.badge}
          </span>
        )}
        ...
        <button className="product-card__add-to-bag">
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
...
function TrendingNow() {
  ...
  const visible = trendingProducts.slice(
    page * ITEMS_PER_PAGE,
  ...
  return (
    <section className="section--trending">
      <div className="trending-header">
        ...
        <Link to="/women" className="trending-header__view-all">
          View All →
        </Link>
      </div>
      ...
      <div className="trending-pagination">
        <button
          className="trending-pagination__arrow"
        ...
        <span className="trending-pagination__info">
          {page + 1} / {totalPages}
        </span>
        <button
          className="trending-pagination__arrow"
